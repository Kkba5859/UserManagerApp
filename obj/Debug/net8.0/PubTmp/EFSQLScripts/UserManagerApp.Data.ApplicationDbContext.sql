...
IF NOT EXISTS (
    ...
    WHERE [MigrationId] = N'20240919091303_InitialCreate'
)
BEGIN
    CREATE TABLE [Roles] (
...
BEGIN
    ...
    VALUES (N'20240919091303_InitialCreate', N'8.0.8');
END;
GO
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20240919093319_Refactor'
)
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20240919093319_Refactor', N'8.0.8');
END;
GO
